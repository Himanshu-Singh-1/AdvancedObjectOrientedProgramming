...
main(int argc, char **argv) {
    ...
    // Test std::put_time().
    {
        ...
        ss << Interpolate("%, %", std::put_time(&tm, "%c %Z"), std::put_time(&tm2, "%c %z"));
        std::cout << ss.str() << std::endl;
        assert(ss.str() == "Mon 02 May 2016 01:53:44 PM DST DST, Mon 02 May 2016 01:53:01 PM DST +0000 Mon May  2 13:53:44 2016 DST, Mon May  2 13:53:01 2016 +0000");
    }
